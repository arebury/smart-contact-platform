...
- `packages/design-system/docs/extender-kit-pro-guia-diseno.md` — guía de diseño: extender el Kit Pro sin romper (conclusiones del ejercicio Tabla Agentes). Versión técnica = customs-catalog §2.8.
