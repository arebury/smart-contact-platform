 ...
 * `aed-preset.ts`. Renders every severity × variant combination so a
 ...
 * goes in `src/app/core/tokens/aed-preset.ts` (the bridge), not here.
 */
@Component({
  selector: 'aed-buttons-gallery',
