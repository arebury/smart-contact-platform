...
export class EntidadesIAStore implements RepoStore<EntidadIA> {
  ...
  addItem(data: Omit<EntidadIA, 'id'>): EntidadIA { return this.store.addItem(data); }
  updateItem(id: number, updates: Partial<EntidadIA>): void { this.store.updateItem(id, updates); }
...
const COLUMNS: readonly RepoColumnDef<EntidadIA>[] = [
  ...
  { key: 'type', labelKey: 'repositories.entidades_ia.type', kind: 'text', accessor: (i) => i.type, width: '128px' },
  { key: 'model', labelKey: 'repositories.entidades_ia.model', kind: 'text', accessor: (i) => i.model, width: '128px' },
  {
...
const FIELDS: readonly RepoFieldDef[] = [
  { key: 'name', labelKey: 'repositories.columns.name', type: 'text', required: true, placeholderKey: 'repositories.entidades_ia.name_placeholder' },
  { key: 'type', labelKey: 'repositories.entidades_ia.type', type: 'text', required: true, placeholderKey: 'repositories.entidades_ia.type_placeholder' },
  { key: 'model', labelKey: 'repositories.entidades_ia.model', type: 'text', required: true, placeholderKey: 'repositories.entidades_ia.model_placeholder' },
