...
export class HorariosStore implements RepoStore<Horario> {
  ...
  addItem(data: Omit<Horario, 'id'>): Horario { return this.store.addItem(data); }
  updateItem(id: number, updates: Partial<Horario>): void { this.store.updateItem(id, updates); }
...
const COLUMNS: readonly RepoColumnDef<Horario>[] = [
  { key: 'name', labelKey: 'repositories.columns.name', kind: 'text', accessor: (i) => i.name, width: '192px', emphasis: true },
  { key: 'schedule', labelKey: 'repositories.horarios.schedule', kind: 'text', accessor: (i) => i.schedule, width: '160px' },
  { key: 'timezone', labelKey: 'repositories.horarios.timezone', kind: 'text', accessor: (i) => i.timezone, width: '160px' },
  {
...
const FIELDS: readonly RepoFieldDef[] = [
  { key: 'name', labelKey: 'repositories.columns.name', type: 'text', required: true, placeholderKey: 'repositories.horarios.name_placeholder' },
  { key: 'schedule', labelKey: 'repositories.horarios.schedule', type: 'text', required: true, placeholderKey: 'repositories.horarios.schedule_placeholder' },
  { key: 'timezone', labelKey: 'repositories.horarios.timezone', type: 'text', placeholderKey: 'repositories.horarios.timezone_placeholder' },
  { key: 'description', labelKey: 'repositories.columns.description', type: 'text', placeholderKey: 'repositories.placeholders.description' },
  {
