...
export const GROUPS_SEED: readonly Group[] = [
  ...
  },
  {
    ...
    strategy: 'Balanceada',
    capacityType: 'fixed',
    capacityValue: '10',    services: ['Atención general'],
  },
  {
    id: 3,
    code: '20003',
    ...
    capacityValue: '3',    services: ['Campañas salientes'],
    schedules: [1],
  },
  {
    id: 4,
    ...
    typification: false,
    channels: ['phone'],
    strategy: 'Lineal',    services: ['Campañas salientes', 'Telemarketing VUI'],
  },
  {
    id: 5,
    code: '20005',
    ...
    typification: false,
    channels: ['phone'],
    strategy: 'Agente exclusivo',    services: ['VIP Empresas'],
    schedules: [6],
  },
  {
    id: 6,
    ...
    ringAllAgents: 3,  },
  {
    ...
    typification: true,
    channels: ['phone'],
    strategy: 'Balanceada',    services: ['Demo interno'],
  },
  {
    id: 9,
    code: '20009',
  ...
  },
  {
    ...
    channels: ['phone', 'chat'],
    strategy: 'Balanceada',
    chatStrategy: 'Rotativa (por turnos)',    services: ['Atención general', 'Soporte técnico', 'Consultas facturación'],
  },
  {
    id: 11,
    code: '20011',
    ...
    strategy: 'Balanceada',
    chatStrategy: 'Menos chats activos',    labels: [3, 6],
  ...
  },
  {
    ...
    channels: ['phone', 'chat'],
    strategy: 'Balanceada',
    chatStrategy: 'Rotativa (por turnos)',    labels: [4, 10],
    templates: [7, 8, 10],
  ...
  },
  {
    ...
    channels: ['phone', 'chat'],
    strategy: 'Lineal',
    chatStrategy: 'Menos chats activos',    services: ['Soporte taller', 'Averías'],
  },
  {
    id: 14,
    code: '20014',
    ...
    typification: false,
    channels: ['phone'],
    strategy: 'Balanceada',    services: ['Telemarketing VUI'],
  },
];
