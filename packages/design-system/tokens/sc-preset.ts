...
export const ScPreset = definePreset(Aura, {
  ...
  semantic: {
    ...
    formField: {
      ...
      /* ⚗️ Exp S68: probé subir a 0-875/0-625 (~34px) pero el input salía a 40.5px
       * (alto para denso) y desencajaba con los botones small → revertido al calibrado. */
  ...
  components: {
    ...
    button: {
      root: {
        ...
        /* ⚗️ Exp S68: bump revertido (ver form-field) — vuelta al calibrado. */
        paddingX: 'var(--sc-scale-0-75)',
        paddingY: 'var(--sc-scale-0-5)',
        borderRadius: 'var(--sc-radius-200)',
