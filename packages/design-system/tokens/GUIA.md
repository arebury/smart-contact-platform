...
- **Escala de tamaños de iconos (S54).** El proyecto usa Lucide
  ...
  escala **redonda en rem** (8/10/12/14/16/18/20/28 px), su propio
  *stream de tipo* (DD-13/S75, decoplada de `--sc-scale`; antes colgaba
  de PrimeOne 4.0 decimal). Cuando cambie, tocar ambos archivos y propagar.

- **Spacing = escala decimal PrimeOne base 14 (S54).** Antes: aditiva
  (4/8/12/16/24/32/...). Ahora: multiplicativa base 14
  (3.5/7/10.5/14/15.75/21/24.5/28/...). Naming SCDS conservado
  (`--sc-spacing-0-5` sigue siendo el nombre, solo el VALOR cambia
  de 8 a 7px). Razón: alinear 1:1 con el Kit Pro Figma. **font-size +
  line-height YA NO van por esta escala** (DD-13/S75): redondos en rem,
  su propio stream (12/14/16/18/20/24/32/48), step-named.
